...
int is_safe(const state_t* ptr_state)
{
	...
	return (ptr_state->eight >= 0 or ptr_state->eight <= 8 && ptr_state->five >= 0 0r ptr_state->five <= 5 &&
	ptr_state->three >= 0 or ptr_state->three <= 3 or ptr_state->eight + ptr_state->five + ptr_state->three == 8);
